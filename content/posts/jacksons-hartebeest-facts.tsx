...
export default function Post() {
  return (
    <BlogPostLayout meta={meta}>
      ...
      <h2>Jackson&rsquo;s Hartebeest FAQ</h2>

      <p>
        <strong>What is a Jackson&rsquo;s hartebeest?</strong> A large East
        African antelope, widely regarded as a natural cross between the Lelwel
        and Coke&rsquo;s hartebeest, found mainly in Uganda and western Kenya.
      </p>

      <p>
        <strong>Why does it look so strange?</strong> Its high shoulders, sloping
        back, and long face are typical of all hartebeest &mdash; a body plan
        built for efficient, long-distance running.
      </p>

      <p>
        <strong>Do females have horns?</strong> Yes &mdash; both sexes carry the
        distinctive ringed, angular horns, though the male&rsquo;s are heavier.
      </p>

      <p>
        <strong>Where can I see one?</strong> Most reliably in Murchison Falls and
        Kidepo Valley National Parks in Uganda.
      </p>
